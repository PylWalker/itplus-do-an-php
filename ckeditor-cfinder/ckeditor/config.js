...
CKEDITOR.editorConfig = function( config ) {
	...
	// config.uiColor = '#AADC6E';
        config.filebrowserBrowseUrl = '/project-xe/ckeditor-cfinder/elfinder/for_ckeditor.html?mode=file';
        config.filebrowserImageBrowseUrl = '/project-xe/ckeditor-cfinder/elfinder/for_ckeditor.html?mode=image';
